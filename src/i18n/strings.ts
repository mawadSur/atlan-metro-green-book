...
export const t: Record<string, Dict> = {
  ...
  aboutText: { en: 'Atlan Metro Green Book helps Muslims find verified halal restaurants, mosques, prayer spaces, and more across Metro Atlanta and World Cup 2026 cities.', ar: 'يساعد دليل أتلان مترو الأخضر المسلمين في العثور على المطاعم الحلال والمساجد والمصليات والمزيد في أنحاء مترو أتلانتا ومدن كأس العالم ٢٠٢٦.', es: 'Atlan Metro Green Book ayuda a los musulmanes a encontrar restaurantes halal verificados, mezquitas, espacios de oración y más en Metro Atlanta y ciudades de la Copa Mundial 2026.' },
  worldCup2026: { en: 'FIFA World Cup 2026', ar: 'كأس العالم لكرة القدم ٢٠٢٦', es: 'Copa Mundial FIFA 2026' },
  worldCupInfo: { en: 'Discover stadiums, prayer spaces, and halal dining near all 16 host cities across the US, Canada, and Mexico.', ar: 'اكتشف الملاعب والمصليات والمطاعم الحلال بالقرب من جميع المدن المضيفة الـ١٦ في الولايات المتحدة وكندا والمكسيك.', es: 'Descubre estadios, espacios de oración y comida halal cerca de las 16 ciudades anfitrionas en EE. UU., Canadá y México.' },
  ...
  notificationsHint: { en: 'Get notified about World Cup matches, prayer spaces, and new halal places near you.', ar: 'احصل على إشعارات حول مباريات كأس العالم والمصليات والأماكن الحلال الجديدة بالقرب منك.', es: 'Recibe notificaciones sobre partidos del Mundial, espacios de oración y nuevos lugares halal cerca de ti.' },
